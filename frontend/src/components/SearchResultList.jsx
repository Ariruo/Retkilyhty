...
function SearchResultList({ results, onResultClick }) {
  return (
    <div className="results-list fixed z-8 bg-white flex flex-col shadow-md rounded-lg max-h-60  overflow-y-auto left-10 sm:left-56 pl-2 pt-2 sm:w-90 w-64 top-72 sm:top-32  " >
