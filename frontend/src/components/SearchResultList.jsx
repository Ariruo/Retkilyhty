...
function SearchResultList({ results, onResultClick }) {
  return (
    <div className="results-list fixed z-10 bg-white flex flex-col shadow-md rounded-lg mt-4 max-h-60 overflow-y-auto left-10 sm:left-56 pl-2 pt-2 w-96 top-72 sm:top-28  " >
